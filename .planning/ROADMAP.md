...
Plans:
- [x] 10-01-PLAN.md — CLEAN-08: InvalidPipelineSlug sentinel + slug regex/resolved-path guard on accept_synthesis and reject_synthesis + parametrized traversal tests
- [x] 10-02-PLAN.md — CLEAN-09: schema split (pipeline_acceptance + pipeline_rejection) + delete sentinel record fields + update pinning tests
...
*Last updated: 2026-04-18 — Phase 11 plans created (DRIFT-01 + NITS-01)*
